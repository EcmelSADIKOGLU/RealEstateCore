...
namespace RealEstate.PresentationLayer.Controllers
{
    public class MailController : Controller
    {
        ...
        public IActionResult Index(MailRequest p)
        {
            ...
            MailboxAddress mailboxAddressFrom = new MailboxAddress("Admin RealEstate","sadikogluecmel@gmail.com");
            ...
            smtpClient.Authenticate("sadikogluecmel@gmail.com", "dyrhdaodhkqmbjzd");
